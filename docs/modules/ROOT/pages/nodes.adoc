...
For an Orchestration, custom signals can be defined and emitted so that other Observers can be notified.
Signals can also be emitted with a variable number of arguments, allowing an Orchestration to pass information to the Observer with ease.
