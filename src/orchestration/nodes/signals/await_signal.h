...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_AWAIT_SIGNAL_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_AWAIT_SIGNAL_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_AWAIT_SIGNAL_H
