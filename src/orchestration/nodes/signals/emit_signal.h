...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_EMIT_SIGNAL_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_EMIT_SIGNAL_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_EMIT_SIGNAL_H
