...
//
#include "orchestration/nodes/function_terminator.h"
...
bool OScriptNodeFunctionTerminator::create_pins_for_function_entry_exit(const Ref<OScriptFunction>& p_function, bool p_function_entry) {
    bool pins_good = true;
    if (p_function_entry) {
