...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_RESOURCE_PATH_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_RESOURCE_PATH_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_RESOURCE_PATH_H
