...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_DIALOGUE_CHOICE_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_DIALOGUE_CHOICE_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_DIALOGUE_CHOICE_H