...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_VARIABLE_GET_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_VARIABLE_GET_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_VARIABLE_GET_H
