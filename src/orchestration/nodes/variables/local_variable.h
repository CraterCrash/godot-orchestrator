...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_LOCAL_VARIABLE_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_LOCAL_VARIABLE_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_LOCAL_VARIABLE_H