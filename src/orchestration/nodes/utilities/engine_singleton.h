...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_ENGINE_SINGLETON_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_ENGINE_SINGLETON_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_ENGINE_SINGLETON_H