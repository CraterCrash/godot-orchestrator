...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_INPUT_ACTION_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_INPUT_ACTION_H
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_INPUT_ACTION_H