...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_NODE_H
#define ORCHESTRATOR_ORCHESTRATION_NODE_H

#include "orchestration/action.h"
#include "orchestration/build_log.h"
#include "orchestration/graph.h"
#include "orchestration/node_factory.h"
#include "orchestration/node_pin.h"
#include "orchestration/target_object.h"
#include "script/language.h" // todo: removal creates include problem - need to find out why
...
#endif // ORCHESTRATOR_ORCHESTRATION_NODE_H