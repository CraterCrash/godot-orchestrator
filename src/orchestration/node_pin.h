...
protected:
    ...
    void _recompute_override_flags();
...
public:
    ...
    /// Gets the effective property type.
    /// This favors the type override if one exists, otherwise the basic property type.
    /// @return the effective property info
    const PropertyInfo& get_effective_property() const;
