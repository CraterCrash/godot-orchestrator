...
//
#ifndef ORCHESTRATOR_ORCHESTRATION_BINARY_FORMAT_H
#define ORCHESTRATOR_ORCHESTRATION_BINARY_FORMAT_H

#include "orchestration/io/orchestration_format.h"

class OrchestrationBinaryFormat : public OrchestrationFormat
{
public:
    static const uint32_t NUM_RESERVED_FIELDS;
...
#endif // ORCHESTRATOR_ORCHESTRATION_BINARY_FORMAT_H