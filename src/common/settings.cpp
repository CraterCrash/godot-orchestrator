...
void OrchestratorSettings::_register_settings() {
    ...
    _settings.emplace_back(BOOL_SETTING("settings/runtime/use_node_convergence", true));
    ...
    _settings.emplace_back(COLOR_NO_ALPHA_SETTING("ui/node_colors/utilities", Color(0.027, 0.156, 0.114)));
