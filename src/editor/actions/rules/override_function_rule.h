...
/// This rule avoids being able to add existing functions that are already defined.
class OrchestratorEditorActionOverrideFunctionRule : public OrchestratorEditorActionFilterRule {
    GDCLASS(OrchestratorEditorActionOverrideFunctionRule, OrchestratorEditorActionFilterRule);

    PackedStringArray _overridden_method_names;
