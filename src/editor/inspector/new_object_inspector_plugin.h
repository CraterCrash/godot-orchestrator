...
class OrchestratorEditorInspectorPluginNewObjectNode : public EditorInspectorPlugin {
    GDCLASS(OrchestratorEditorInspectorPluginNewObjectNode, EditorInspectorPlugin);
