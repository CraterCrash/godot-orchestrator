...
//
#ifndef ORCHESTRATOR_EDITOR_GRAPH_PIN_COLOR_PICKER_H
#define ORCHESTRATOR_EDITOR_GRAPH_PIN_COLOR_PICKER_H
...
#endif // ORCHESTRATOR_EDITOR_GRAPH_PIN_COLOR_PICKER_H