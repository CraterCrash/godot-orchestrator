...
//
#ifndef ORCHESTRATOR_EDITOR_VARIABLE_CLASSIFICATION_DIALOG_H
#define ORCHESTRATOR_EDITOR_VARIABLE_CLASSIFICATION_DIALOG_H
...
/// Specialization of the OrchestratorEditorSearchDialog specifically for variable type classifications
class OrchestratorVariableTypeSearchDialog : public OrchestratorEditorSearchDialog
{
    GDCLASS(OrchestratorVariableTypeSearchDialog, OrchestratorEditorSearchDialog);
...
protected:
    ...
    PackedStringArray _get_class_hiearchy(const String& p_class);

    /// Get the class hiearchy search items
    /// @param p_class the class
    /// @param r_cache the search item cache
    /// @param p_root the root search item
    Vector<Ref<SearchItem>> _get_class_hierarchy_search_items(const String& p_class, HashMap<String,
                                                              Ref<SearchItem>>& r_cache, const Ref<SearchItem>& p_root);
...
#endif  // ORCHESTRATOR_EDITOR_VARIABLE_CLASSIFICATION_DIALOG_H