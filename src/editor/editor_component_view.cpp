...
OrchestratorEditorComponentView::OrchestratorEditorComponentView()
{
    ...
    _add_button->connect("pressed", callable_mp(this, &OrchestratorEditorComponentView::_add_button_pressed));
    ...
    _tree->connect("item_collapsed", callable_mp(this, &OrchestratorEditorComponentView::_tree_item_collapsed));
    _tree->connect("item_mouse_selected", callable_mp(this, &OrchestratorEditorComponentView::_tree_item_mouse_selected));
    _tree->connect("item_selected", callable_mp(this, &OrchestratorEditorComponentView::_tree_item_selected));
    _tree->connect("item_activated", callable_mp(this, &OrchestratorEditorComponentView::_tree_item_activated));
    _tree->connect("button_clicked", callable_mp(this, &OrchestratorEditorComponentView::_tree_item_button_clicked));
    _tree->connect("gui_input", callable_mp(this, &OrchestratorEditorComponentView::_tree_gui_input));
    _tree->set_drag_forwarding(callable_mp(this, &OrchestratorEditorComponentView::_tree_drag), Callable(), Callable());
    add_child(_tree);

    _collapse_button->connect("pressed", callable_mp(this, &OrchestratorEditorComponentView::toggle_collapse));
}