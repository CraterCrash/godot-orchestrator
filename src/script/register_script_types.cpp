...
void register_script_types()
{
    ...
    ORCHESTRATOR_REGISTER_INTERNAL_CLASS(OScriptVariableBase)
...
void register_script_node_types()
{
    ...
    ORCHESTRATOR_REGISTER_ABSTRACT_NODE_CLASS(OScriptNodeVariableBase)
    ORCHESTRATOR_REGISTER_ABSTRACT_NODE_CLASS(OScriptNodeLocalVariableBase)
    ORCHESTRATOR_REGISTER_ABSTRACT_NODE_CLASS(OScriptNodeScriptVariableBase)
