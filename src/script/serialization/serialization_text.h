...
//
#ifndef ORCHESTRATOR_SCRIPT_SERIALIZATION_TEXT_H
#define ORCHESTRATOR_SCRIPT_SERIALIZATION_TEXT_H
...
/// A ResourceFormatLoader that loads an OScript resource files using text format
...
/// A ResourceFormatSaver that saves a OScript resource files using text format
...
#endif // ORCHESTRATOR_SCRIPT_SERIALIZATION_TEXT_H