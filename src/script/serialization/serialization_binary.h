...
//
#ifndef ORCHESTRATOR_SCRIPT_SERIALIZATION_BINARY_H
#define ORCHESTRATOR_SCRIPT_SERIALIZATION_BINARY_H
...
/// A ResourceFormatLoader that loads OScript resource files using binary format
...
/// A ResourceFormatSaver that saves a OScript resource files using binary format
...
#endif // ORCHESTRATOR_SCRIPT_SERIALIZATION_BINARY_H