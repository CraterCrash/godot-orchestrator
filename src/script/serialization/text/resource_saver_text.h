...
//
#ifndef ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_SAVER_TEXT_H
#define ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_SAVER_TEXT_H
...
/// A text-based resource format saver for OScript script resources.
class OScriptTextResourceFormatSaver : public ResourceFormatSaver {
    GDCLASS(OScriptTextResourceFormatSaver, ResourceFormatSaver);
...
#endif // ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_SAVER_TEXT_H