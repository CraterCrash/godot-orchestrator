...
/// A binary-based resource format saver for OScript script resources.
class OScriptBinaryResourceFormatSaver : public ResourceFormatSaver {
    GDCLASS(OScriptBinaryResourceFormatSaver, ResourceFormatSaver);
