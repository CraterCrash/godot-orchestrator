...
//
#ifndef ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_LOADER_BINARY_H
#define ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_LOADER_BINARY_H
...
class OScriptBinaryResourceFormatLoader : public ResourceFormatLoader {
    GDCLASS(OScriptBinaryResourceFormatLoader, ResourceFormatLoader);

    friend class OScriptCache;

    static bool _is_binary_script(const String& p_path);
...
#endif // ORCHESTRATOR_SCRIPT_SERIALIZATION_RESOURCE_LOADER_BINARY_H