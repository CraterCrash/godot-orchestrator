...
//
#ifndef ORCHESTRATOR_NODE_CUSTOM_EVENT_V2_H
#define ORCHESTRATOR_NODE_CUSTOM_EVENT_V2_H
...
///
class OScriptNodeCustomEvent_V2 : public OScriptNodeFunctionEntry
{
    ORCHESTRATOR_NODE_CLASS(OScriptNodeCustomEvent_V2, OScriptNodeFunctionEntry);
...
#endif  // ORCHESTRATOR_NODE_CUSTOM_EVENT_V2_H