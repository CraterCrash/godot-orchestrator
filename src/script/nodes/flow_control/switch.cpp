...
void OScriptNodeSwitchEnum::post_initialize() {
    const Ref<OScriptNodePin> pin = find_pin("value", PD_Input);
    if (pin.is_valid()) {
        if (pin->is_enum()) {
