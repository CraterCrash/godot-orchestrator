    ...
    namespace internal
    {
		...
		void ExtensionDBLoader::prime_builtin_classes()
		{
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::INT, "int", Variant::INT, "int", Variant::INT });
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::NIL, "Variant", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_NOT, "not", "Not", Variant::STRING, "String", Variant::NIL, "", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::BOOL, "bool", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::INT, "int", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::FLOAT, "float", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::STRING, "String", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING, "String", Variant::STRING, "String", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR2, "Vector2", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR2I, "Vector2i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::RECT2, "Rect2", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::RECT2I, "Rect2i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR3, "Vector3", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR3I, "Vector3i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::TRANSFORM2D, "Transform2D", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR4, "Vector4", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::VECTOR4I, "Vector4i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PLANE, "Plane", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::QUATERNION, "Quaternion", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::AABB, "AABB", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::BASIS, "Basis", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::TRANSFORM3D, "Transform3D", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PROJECTION, "Projection", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::COLOR, "Color", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::STRING_NAME, "StringName", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING, "String", Variant::STRING_NAME, "StringName", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::NODE_PATH, "NodePath", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::RID, "RID", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::OBJECT, "Object", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING, "String", Variant::OBJECT, "Object", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::CALLABLE, "Callable", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::SIGNAL, "Signal", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::DICTIONARY, "Dictionary", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING, "String", Variant::DICTIONARY, "Dictionary", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::ARRAY, "Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING, "String", Variant::ARRAY, "Array", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_BYTE_ARRAY, "PackedByteArray", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_INT32_ARRAY, "PackedInt32Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_INT64_ARRAY, "PackedInt64Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_FLOAT32_ARRAY, "PackedFloat32Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_FLOAT64_ARRAY, "PackedFloat64Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_STRING_ARRAY, "PackedStringArray", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_VECTOR2_ARRAY, "PackedVector2Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_VECTOR3_ARRAY, "PackedVector3Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_COLOR_ARRAY, "PackedColorArray", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING, "String", Variant::PACKED_VECTOR4_ARRAY, "PackedVector4Array", Variant::STRING });
				type.constructors.push_back({ {  } });
				type.constructors.push_back({ { PropertyInfo(Variant::STRING, "from") } });
				...
				type.method_hashes["substr"] = 787537301;
				...
				type.method_hashes["get_slice"] = 3535100402;
				...
				type.method_hashes["get_slicec"] = 787537301;
				...
				type.method_hashes["get_slice_count"] = 2920860731;
				...
				type.method_hashes["find"] = 1760645412;
				...
				type.method_hashes["findn"] = 1760645412;
				...
				type.method_hashes["count"] = 2343087891;
				...
				type.method_hashes["countn"] = 2343087891;
				...
				type.method_hashes["rfind"] = 1760645412;
				...
				type.method_hashes["is_subsequence_of"] = 2566493496;
				...
				type.method_hashes["format"] = 3212199029;
				...
				type.method_hashes["replace"] = 1340436205;
				...
				type.method_hashes["replacen"] = 1340436205;
				...
				type.method_hashes["replace_char"] = 787537301;
				...
				type.method_hashes["insert"] = 248737229;
				...
				type.method_hashes["split"] = 1252735785;
				...
				type.method_hashes["rsplit"] = 1252735785;
				...
				type.method_hashes["split_floats"] = 2092079095;
				...
				type.method_hashes["lpad"] = 248737229;
				...
				type.method_hashes["trim_prefix"] = 3134094431;
				...
				type.method_hashes["num_scientific"] = 2710373411;
				...
				type.method_hashes["num"] = 1555901022;
				...
				type.method_hashes["num_int64"] = 2111271071;
			...
			}
			{
				...
				type.method_hashes["lerp"] = 4250033116;
				...
				type.method_hashes["slerp"] = 4250033116;
				...
				type.method_hashes["cubic_interpolate"] = 193522989;
				...
				type.method_hashes["cubic_interpolate_in_time"] = 1957055074;
				...
				type.method_hashes["bezier_interpolate"] = 193522989;
				...
				type.method_hashes["clamp"] = 318031021;
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR2I, "Vector2i", Variant::INT, "int", Variant::VECTOR2I });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR2I, "Vector2i", Variant::VECTOR2I, "Vector2i", Variant::VECTOR2I });
				...
				type.method_hashes["distance_to"] = 707501214;
				...
				type.method_hashes["clamp"] = 186568249;
			...
			}
			{
				...
				type.method_hashes["grow_side"] = 4177736158;
			...
			}
			{
				...
				type.method_hashes["grow_side"] = 3191154199;
			...
			}
			{
				...
				type.method_hashes["angle_to"] = 1047977935;
				...
				type.method_hashes["distance_squared_to"] = 1047977935;
				type.methods.push_back(_make_method("length", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::FLOAT, {  }));
				type.method_hashes["length"] = 466405837;
				type.methods.push_back(_make_method("length_squared", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::FLOAT, {  }));
				type.method_hashes["length_squared"] = 466405837;
				...
				type.method_hashes["clamp"] = 4145107892;
				...
				type.method_hashes["rotated"] = 1682608829;
				...
				type.method_hashes["lerp"] = 1682608829;
				...
				type.method_hashes["slerp"] = 1682608829;
				...
				type.method_hashes["cubic_interpolate"] = 2597922253;
				...
				type.method_hashes["cubic_interpolate_in_time"] = 3256682901;
				...
				type.method_hashes["bezier_interpolate"] = 2597922253;
				...
				type.method_hashes["bezier_derivative"] = 2597922253;
				...
				type.method_hashes["octahedron_decode"] = 3991820552;
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR3I, "Vector3i", Variant::INT, "int", Variant::VECTOR3I });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR3I, "Vector3i", Variant::VECTOR3I, "Vector3i", Variant::VECTOR3I });
				...
				type.method_hashes["distance_to"] = 1975170430;
				...
				type.method_hashes["clamp"] = 1086892323;
			...
			}
			{
				...
				type.method_hashes["rotated_local"] = 729597514;
				...
				type.method_hashes["scaled"] = 1446323263;
				...
				type.method_hashes["scaled_local"] = 1446323263;
				...
				type.method_hashes["translated"] = 1446323263;
				...
				type.method_hashes["basis_xform_inv"] = 2026743667;
				...
				type.method_hashes["is_equal_approx"] = 3837431929;
				type.methods.push_back(_make_method("is_finite", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::BOOL, {  }));
				type.method_hashes["is_finite"] = 3918633141;
				...
				type.method_hashes["looking_at"] = 1446323263;
			...
			}
			{
				...
				type.method_hashes["lerp"] = 2329757942;
				...
				type.method_hashes["cubic_interpolate"] = 726768410;
				...
				type.method_hashes["clamp"] = 823915692;
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR4I, "Vector4i", Variant::INT, "int", Variant::VECTOR4I });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::VECTOR4I, "Vector4i", Variant::VECTOR4I, "Vector4i", Variant::VECTOR4I });
				...
				type.method_hashes["clamp"] = 3046490913;
				...
				type.method_hashes["distance_squared_to"] = 346708794;
			...
			}
			{
				...
				type.method_hashes["is_equal_approx"] = 1150170233;
				type.methods.push_back(_make_method("is_finite", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::BOOL, {  }));
				type.method_hashes["is_finite"] = 3918633141;
				...
				type.method_hashes["is_point_over"] = 1749054343;
				...
				type.method_hashes["has_point"] = 1258189072;
				...
				type.method_hashes["intersect_3"] = 2012052692;
				...
				type.method_hashes["intersects_ray"] = 2048133369;
				...
				type.method_hashes["intersects_segment"] = 2048133369;
			...
			}
			{
				...
				type.method_hashes["normalized"] = 4274879941;
				type.methods.push_back(_make_method("is_normalized", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::BOOL, {  }));
				type.method_hashes["is_normalized"] = 3918633141;
				...
				type.method_hashes["slerp"] = 1773590316;
				...
				type.method_hashes["slerpni"] = 1773590316;
				...
				type.method_hashes["spherical_cubic_interpolate"] = 2150967576;
			...
			}
			{
				...
				type.method_hashes["from_euler"] = 2802321791;
			...
			}
			{
				...
				type.method_hashes["rotated"] = 1563203923;
				...
				type.method_hashes["rotated_local"] = 1563203923;
				...
				type.method_hashes["scaled"] = 1405596198;
				...
				type.method_hashes["scaled_local"] = 1405596198;
				...
				type.method_hashes["translated"] = 1405596198;
				...
				type.method_hashes["translated_local"] = 1405596198;
				...
				type.method_hashes["looking_at"] = 90889270;
				...
				type.method_hashes["interpolate_with"] = 1786453358;
				...
				type.method_hashes["is_equal_approx"] = 696001652;
				type.methods.push_back(_make_method("is_finite", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::BOOL, {  }));
				type.method_hashes["is_finite"] = 3918633141;
			...
			}
			{
				...
				type.method_hashes["create_depth_correction"] = 1228516048;
				...
				type.method_hashes["create_light_atlas_rect"] = 2654950662;
				...
				type.method_hashes["create_perspective"] = 390915442;
				...
				type.method_hashes["create_perspective_hmd"] = 2857674800;
				...
				type.method_hashes["create_for_hmd"] = 4184144994;
				...
				type.method_hashes["create_orthogonal"] = 3707929169;
				...
				type.method_hashes["create_orthogonal_aspect"] = 390915442;
				...
				type.method_hashes["create_frustum"] = 3707929169;
				...
				type.method_hashes["create_frustum_aspect"] = 1535076251;
				...
				type.method_hashes["create_fit_aabb"] = 2264694907;
				type.methods.push_back(_make_method("determinant", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::FLOAT, {  }));
				type.method_hashes["determinant"] = 466405837;
				...
				type.method_hashes["perspective_znear_adjusted"] = 3584785443;
				...
				type.method_hashes["jitter_offseted"] = 2448438599;
			...
			}
			{
				...
				type.method_hashes["html_is_valid"] = 2942997125;
				...
				type.method_hashes["from_string"] = 3755044230;
				...
				type.method_hashes["from_hsv"] = 1573799446;
				...
				type.method_hashes["from_rgba8"] = 3072934735;
			...
			}
			{
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::NIL, "Variant", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_NOT, "not", "Not", Variant::STRING_NAME, "StringName", Variant::NIL, "", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::BOOL, "bool", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::INT, "int", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::FLOAT, "float", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::STRING, "String", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING_NAME, "StringName", Variant::STRING, "String", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR2, "Vector2", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR2I, "Vector2i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::RECT2, "Rect2", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::RECT2I, "Rect2i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR3, "Vector3", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR3I, "Vector3i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::TRANSFORM2D, "Transform2D", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR4, "Vector4", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::VECTOR4I, "Vector4i", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PLANE, "Plane", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::QUATERNION, "Quaternion", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::AABB, "AABB", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::BASIS, "Basis", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::TRANSFORM3D, "Transform3D", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PROJECTION, "Projection", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::COLOR, "Color", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::STRING_NAME, "StringName", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::NODE_PATH, "NodePath", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::RID, "RID", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::OBJECT, "Object", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING_NAME, "StringName", Variant::OBJECT, "Object", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::CALLABLE, "Callable", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::SIGNAL, "Signal", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::DICTIONARY, "Dictionary", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::ARRAY, "Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_IN, "in", "In", Variant::STRING_NAME, "StringName", Variant::ARRAY, "Array", Variant::BOOL });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_BYTE_ARRAY, "PackedByteArray", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_INT32_ARRAY, "PackedInt32Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_INT64_ARRAY, "PackedInt64Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_FLOAT32_ARRAY, "PackedFloat32Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_FLOAT64_ARRAY, "PackedFloat64Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_STRING_ARRAY, "PackedStringArray", Variant::STRING });
				...
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_VECTOR2_ARRAY, "PackedVector2Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_VECTOR3_ARRAY, "PackedVector3Array", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_COLOR_ARRAY, "PackedColorArray", Variant::STRING });
				type.operators.push_back({ VariantOperators::OP_MODULE, "%", "Modulo", Variant::STRING_NAME, "StringName", Variant::PACKED_VECTOR4_ARRAY, "PackedVector4Array", Variant::STRING });
				type.constructors.push_back({ {  } });
				type.constructors.push_back({ { PropertyInfo(Variant::STRING_NAME, "from") } });
				type.constructors.push_back({ { PropertyInfo(Variant::STRING, "from") } });
				type.methods.push_back(_make_method("casecmp_to", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::INT, { { Variant::STRING, "to" } }));
			...
			}
			{
				...
				type.method_hashes["merge"] = 2079548978;
				...
				type.method_hashes["merged"] = 2271165639;
				...
				type.method_hashes["find_key"] = 1988825835;
				...
				type.method_hashes["duplicate_deep"] = 2160600714;
				...
				type.method_hashes["get"] = 2205440559;
				...
				type.method_hashes["get_or_add"] = 1052551076;
				...
				type.method_hashes["is_same_typed"] = 3471775634;
				...
				type.method_hashes["is_same_typed_key"] = 3471775634;
				...
				type.method_hashes["recursive_equal"] = 1404404751;
			...
			}
			{
				...
				type.method_hashes["set"] = 3798478031;
				...
				type.method_hashes["push_back"] = 3316032543;
				...
				type.method_hashes["push_front"] = 3316032543;
				...
				type.method_hashes["fill"] = 3316032543;
				...
				type.method_hashes["find"] = 2336346817;
				...
				type.method_hashes["find_custom"] = 2145562546;
				...
				type.method_hashes["rfind"] = 2336346817;
				...
				type.method_hashes["rfind_custom"] = 2145562546;
				...
				type.method_hashes["count"] = 1481661226;
				...
				type.method_hashes["bsearch"] = 3372222236;
				...
				type.method_hashes["duplicate_deep"] = 1949240801;
			...
			}
			{
				...
				type.method_hashes["has"] = 931488181;
				type.methods.push_back(_make_method("reverse", METHOD_FLAG_NORMAL, Variant::NIL, {  }));
				type.method_hashes["reverse"] = 3218959716;
				...
				type.method_hashes["find"] = 2984303840;
				...
				type.method_hashes["get_string_from_multibyte_char"] = 3134094431;
				type.methods.push_back(_make_method("hex_encode", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::STRING, {  }));
				type.method_hashes["hex_encode"] = 3942272618;
				...
				type.method_hashes["compress"] = 1845905913;
				...
				type.method_hashes["decompress"] = 2278869132;
				...
				type.method_hashes["decode_half"] = 1401583798;
				...
				type.method_hashes["decode_float"] = 1401583798;
				...
				type.method_hashes["decode_double"] = 1401583798;
				...
				type.method_hashes["has_encoded_var"] = 2914632957;
				...
				type.method_hashes["decode_var"] = 1740420038;
				...
				type.method_hashes["encode_half"] = 1113000516;
				...
				type.method_hashes["encode_float"] = 1113000516;
				...
				type.method_hashes["encode_double"] = 1113000516;
				...
				type.method_hashes["encode_var"] = 2604460497;
			...
			}
			{
				...
				type.method_hashes["append_array"] = 1087733270;
				type.methods.push_back(_make_method("remove_at", METHOD_FLAG_NORMAL, Variant::NIL, { { Variant::INT, "index" } }));
				type.method_hashes["remove_at"] = 2823966027;
				type.methods.push_back(_make_method("insert", METHOD_FLAG_NORMAL, Variant::INT, { { Variant::INT, "at_index" }, { Variant::INT, "value" } }));
				type.method_hashes["insert"] = 1487112728;
			...
			}
			{
				...
				type.method_hashes["append_array"] = 2090311302;
				type.methods.push_back(_make_method("remove_at", METHOD_FLAG_NORMAL, Variant::NIL, { { Variant::INT, "index" } }));
				type.method_hashes["remove_at"] = 2823966027;
				type.methods.push_back(_make_method("insert", METHOD_FLAG_NORMAL, Variant::INT, { { Variant::INT, "at_index" }, { Variant::INT, "value" } }));
				type.method_hashes["insert"] = 1487112728;
				...
				type.method_hashes["slice"] = 1726550804;
				type.methods.push_back(_make_method("to_byte_array", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::PACKED_BYTE_ARRAY, {  }));
				type.method_hashes["to_byte_array"] = 247621236;
				type.methods.push_back(_make_method("sort", METHOD_FLAG_NORMAL, Variant::NIL, {  }));
				type.method_hashes["sort"] = 3218959716;
				...
				type.method_hashes["duplicate"] = 2376370016;
				type.methods.push_back(_make_method("find", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::INT, { { Variant::INT, "value" }, { Variant::INT, "from" } }));
				type.method_hashes["find"] = 2984303840;
				type.methods.push_back(_make_method("rfind", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::INT, { { Variant::INT, "value" }, { Variant::INT, "from" } }));
				type.method_hashes["rfind"] = 2984303840;
			...
			}
			{
				...
				type.method_hashes["find"] = 1343150241;
			...
			}
			{
				...
				type.method_hashes["append_array"] = 792078629;
				type.methods.push_back(_make_method("remove_at", METHOD_FLAG_NORMAL, Variant::NIL, { { Variant::INT, "index" } }));
				type.method_hashes["remove_at"] = 2823966027;
				type.methods.push_back(_make_method("insert", METHOD_FLAG_NORMAL, Variant::INT, { { Variant::INT, "at_index" }, { Variant::FLOAT, "value" } }));
				type.method_hashes["insert"] = 1379903876;
				...
				type.method_hashes["slice"] = 2192974324;
				type.methods.push_back(_make_method("to_byte_array", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::PACKED_BYTE_ARRAY, {  }));
				type.method_hashes["to_byte_array"] = 247621236;
				type.methods.push_back(_make_method("sort", METHOD_FLAG_NORMAL, Variant::NIL, {  }));
				type.method_hashes["sort"] = 3218959716;
				...
				type.method_hashes["duplicate"] = 949266573;
				type.methods.push_back(_make_method("find", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::INT, { { Variant::FLOAT, "value" }, { Variant::INT, "from" } }));
				type.method_hashes["find"] = 1343150241;
				type.methods.push_back(_make_method("rfind", METHOD_FLAG_NORMAL | METHOD_FLAG_CONST, Variant::INT, { { Variant::FLOAT, "value" }, { Variant::INT, "from" } }));
				type.method_hashes["rfind"] = 1343150241;
			...
			}
			{
				...
				type.method_hashes["find"] = 1469606149;
			...
			}
			{
				...
				type.method_hashes["find"] = 3718155780;
			...
			}
			{
				...
				type.method_hashes["find"] = 3156095363;
			...
			}
			{
				...
				type.method_hashes["find"] = 3091171314;
