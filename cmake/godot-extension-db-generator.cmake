...
FUNCTION( GENERATE_GODOT_EXTENSION_DB )
    ...
    IF(NOT ${pos} EQUAL -1)
        ...
        CONFIGURE_FILE(cmake/extension_db.h.in ${CMAKE_CURRENT_SOURCE_DIR}/src/api/extension_db.h @ONLY)
        CONFIGURE_FILE(cmake/extension_db.cpp.in ${CMAKE_CURRENT_SOURCE_DIR}/src/api/extension_db.cpp @ONLY)
    ENDIF()
ENDFUNCTION()